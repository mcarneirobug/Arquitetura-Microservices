package com.matheus.auth;

import com.matheus.auth.model.Permission;
import com.matheus.auth.model.User;
import com.matheus.auth.modules.permission.service.impl.PermissionRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository,
		...
		User find = userRepository.findByUserName("matheus");
